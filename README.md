...
- [サンプルチュートリアル](datability_web_option.ipynb)
...
- ローカル環境にPython + OpenCVを導入し、[サンプルチュートリアル](datability_web_option.ipynb)を参考に進めて、最後に[課題実装用雛形](option_sample.py)に実装してください。
